  ...
  api:
    ...
    logging:
      ...
      options:
        max-size: '800k'
        max-file: '10'
#    command: -verbose -listen ss://:8388 -forward ss://45.32.55.96:8388
    command: -verbose -listen ss://AEAD_AES_256_GCM:525272@api:8388 -forward ss://AEAD_AES_256_GCM:525272@45.32.55.96:8388
EOF
